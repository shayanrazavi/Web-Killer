...
def sign_out_command(update,context):
    ...
    if log_position == 3:
        ...
        log_position = 0
        sign_position = 0
        update.message.reply_text("Error, you must log in to your account before you can sign out. /log_in /sign_in")
...
def log_out_command(update,context):
    ...
    if log_position == 3:
        ...
        log_position = 0
        sign_position = 0
        update.message.reply_text("Error, you must log in or sign in to your account before you can log out. /log_in /log_out")
...
dp.add_handler(CommandHandler("cryptography",cryptography_command))
dp.add_handler(CommandHandler("decryption",decryption_command))
